...
translate("「全能推送」，英文名「PushBot」，是一款从服务器推送报警信息和日志到各平台的工具。<br>支持钉钉推送，企业微信推送，PushPlus推送。<br>本插件由tty228/luci-app-serverchan创建，然后七年修改为全能推送自用。<br /><br>现在满哥自己维护了一个版本，支持自建token加密<br /><br>Fork: Disappear9/luci-app-pushbot<br /><br />如果你在使用中遇到问题，请到这里提交：")
